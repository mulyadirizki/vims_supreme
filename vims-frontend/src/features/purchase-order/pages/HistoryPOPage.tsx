...
import { usePOHistory } from "../hooks/use-po-history";
...
const TABLE_HEADS = ["PO No", "Store", "Department", "Supplier", "Doc Date", "Est Delivery Date", "Amount", "Vat", "Total", "Status"];

export default function HistoryPOPage() {
  ...
  const { data, isLoading, isError } = usePOHistory(filter);
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      <div>
        <h1 className="text-[15px] font-bold text-gray-800">History PO</h1>
        <p className="text-[11px] text-gray-400 mt-0.5">Purchase order yang sudah selesai (paid) atau dibatalkan</p>
      </div>
        ...
        <div className="overflow-auto flex-1">
          <Table className="min-w-[800px] w-full">
            ...
            <TableBody>
              ...
              {isError && (
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-16 text-red-400 text-[12px]">
              ...
              {!isLoading && !isError && list.length === 0 && (
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-16 text-gray-400 text-[12px]">
              ...
              {!isLoading && !isError && list.map((po) => (
                ...
                >
                  ...
                  <TableCell className="text-[11px] font-semibold text-gray-800 text-right whitespace-nowrap py-2.5">
